...
#     label_file = label_file.replace('/data/datasets/', 'data/')
#     Path('/'.join(label_file.split('/')[:-1])).mkdir(parents=True, exist_ok=True)
...
def parse_args():
    ...
    parser.add_argument('acdc_path', help='ACDC data path')
